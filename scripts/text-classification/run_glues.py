...
def main():
    ...
    if data_args.dataset_name is not None:
        if 'sts' in data_args.dataset_name:
            task_name_aux = 'stsb'
        ...
        if  'STR' in data_args.train_file:
            task_name_aux = 'stsb'
        else:
            task_name_aux = 'sst2'

    metric = evaluate.load("glue", task_name_aux)
    ...
    if training_args.do_predict:
        ...
        if data_args.dataset_name is not None:
            if 'sts' in data_args.dataset_name:
                ...
                task_name_aux = data_args.dataset_name
        else:
            task_name_aux = 'sst2'
        tasks = [task_name_aux]
        predict_datasets = [predict_dataset]
        if task_name_aux == "mnli":
            tasks.append("mnli-mm")
